...
# install_package "${prefix}boost-staticdev_1.63.0-r1.5_cortexa9-vfpv3.ipk"
# install_package "${prefix}boost-test_1.63.0-r1.5_cortexa9-vfpv3.ipk"
# install_package "${prefix}boost_1.63.0-r1.5_cortexa9-vfpv3.ipk"
...
install_package "${prefix}libboost-graph1.63.0_1.63.0-r1.5_cortexa9-vfpv3.ipk"
install_package "${prefix}libboost-iostreams1.63.0_1.63.0-r1.5_cortexa9-vfpv3.ipk"
install_package "${prefix}libboost-program-options1.63.0_1.63.0-r1.5_cortexa9-vfpv3.ipk"
install_package "${prefix}libboost-random1.63.0_1.63.0-r1.5_cortexa9-vfpv3.ipk"
